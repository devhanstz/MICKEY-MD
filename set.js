...
module.exports = {
  ...
  'OWNER_NAME': process.env.OWNER_NAME || "𝚳𝚰𝐂𝐊𝐘-𝚳𝐃 🌴",
  'NUMERO_OWNER': process.env.NUMERO_OWNER || "255764865661",
  'AUTO_READ_STATUS': process.env.AUTO_READ_STATUS || "non",
  'AUTO_DOWNLOAD_STATUS': process.env.AUTO_DOWNLOAD_STATUS || "non",
  'BOT': process.env.BOT_NAME || "𝚳𝚰𝐂𝐊𝐘-𝚳𝐃 🌴",
  'URL': process.env.BOT_MENU_LINKS || "https://i.ibb.co/sp3NTH9T/hanstz.jpg",
